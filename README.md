...
- **Accès en ligne** : Le projet est accessible à l'adresse `188.165.222.102:3000`. Assurez-vous de désactiver les proxy si vous êtes sur un réseau universitaire car le port 3000 est bloqué sur ce dernier.
